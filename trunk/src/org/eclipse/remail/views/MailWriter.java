...
/**
 * Class used to provide to the user a nice interface
 * for writing e-mails
 * 
...
public class MailWriter extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		//content field
		contentField=new StyledText(text, SWT.MULTI | SWT.WRAP | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
		contentField.setLayoutData(gd1);
		
		//keyword field
		keywordsField=new StyledText(text, SWT.MULTI | SWT.WRAP | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
